...
import org.mobilitydata.gtfsvalidator.util.GtfsFeedContainerPredicates;
...
public class MissingShapesFileValidator extends FileValidator {
  ...
  public void validate(NoticeContainer noticeContainer) {
    ...
    boolean hasZoneBasedDrt =
        GtfsFeedContainerPredicates.hasAtLeastOneTripWithOnlyLocationId(feedContainer);
    boolean hasFixedStopsDrt =
        GtfsFeedContainerPredicates.hasAtLeastOneRecordInFile(feedContainer, "location_groups.txt")
            && GtfsFeedContainerPredicates.hasAtLeastOneTripWithOnlyLocationGroupId(feedContainer);
